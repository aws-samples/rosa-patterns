# ROSA PrivateLink cluster for Centralized Internet Egress

## Solution Architecture

![ROSA PrivateLink cluster for Centralized Internet Egress](../../../assets/rosa-privatelink-egress-vpc.png)
